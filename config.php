...
function searchPinjamAdmin($keyword)
{
  ...
  $searchPinjam = "SELECT peminjaman.id, peminjaman.id_buku, buku.cover, buku.judul, peminjaman.nisn, member.nama, user.username, peminjaman.harga, user.telp, peminjaman.tgl_pinjam, peminjaman.tgl_kembali, peminjaman.status
        FROM peminjaman
...
function searchPinjamMember($keyword)
{
    ...
    // Search Peminjaman Member
    $searchPinjam = "SELECT peminjaman.id AS peminjaman.id, peminjaman.id_buku, buku.cover, buku.judul, peminjaman.nisn, member.nama, user.username, peminjaman.harga, user.telp, peminjaman.tgl_pinjam, peminjaman.tgl_kembali, peminjaman.status
        FROM peminjaman
        INNER JOIN buku ON peminjaman.id_buku = buku.id_buku
        INNER JOIN member ON peminjaman.nisn = member.nisn
        INNER JOIN user ON peminjaman.id_user = user.id
